...
Route::get('/kategori/tampil',[KategoriController::class, 'tampildata']);
Route::get('/pengguna/tampil',[PenggunaController::class, 'tampildata']);
Route::get('/kas_masuk/tampil',[KasMasukController::class, 'tampildata']);
...
Route::get('/kas_keluar/tampil',[KasKeluarController::class, 'tampildata']);
